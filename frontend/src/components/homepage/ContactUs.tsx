        ...
        <div className="relative z-10 space-y-4 mt-10 flex flex-col lg:flex-row justify-between w-full max-w-6xl px-4">
          ...
          <div className="text-left space-y-4 lg:w-1/2 flex flex-col items-center mt-4 lg:mt-0">
            ...
            <ul className="space-y-2">
              <li><a href="/event-gallery" className="text-white hover:text-orange-400 transition">Event Gallery</a></li>
              <li><a href="/image-gallery" className="text-white hover:text-orange-400 transition">Image Gallery</a></li>
              <li><a href="/video-gallery" className="text-white hover:text-orange-400 transition">Video Gallery</a></li>
              <li><a href="/news-media" className="text-white hover:text-orange-400 transition">News & Media</a></li>
            </ul>
          </div>
        </div>
      </div>
