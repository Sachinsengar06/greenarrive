    ...
    <div className="bg-green-50 min-h-screen flex flex-col items-center text-gray-800 mt-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 px-8 pb-12">
        {features.map((feature, index) => (
          <div
            key={index}
            className="p-6 bg-white shadow-lg rounded-xl flex flex-col items-center text-center transition-transform duration-300 hover:scale-105"
          >
      ...
      <div className="bg-green-700 text-white text-center py-12 px-6 w-full">
